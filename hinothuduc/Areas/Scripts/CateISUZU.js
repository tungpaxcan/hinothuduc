...
function CateISUZU(pagenum, page, seach) {
    var Stt = 1;
    $.ajax({
        url: '/CateISUZU/List',
        type: 'get',
        ...
        success: function (data) {
            ...
            if (data.code == 200) {
                $.each(data.c, function (k, v) {
                    ...
                    table += '<a class="nav-link" href="/Hino/CateISUZU/Edits/' + v.id + '">';
    ...
    $.ajax({
        ...
        success: function (data) {
            if (data.code == 200) {
                ...
                window.location.href = "/Hino/CateISUZU/Index";
