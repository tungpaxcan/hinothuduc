...
function Service(pagenum, page, seach) {
    var Stt = 1;
    $.ajax({
        url: '/service/List',
        type: 'get',
        ...
        success: function (data) {
            ...
            if (data.code == 200) {
                $.each(data.c, function (k, v) {
                    ...
                    table += '<a class="nav-link" href="/Hino/Service/Edits/' + v.id + '">';
    ...
    $.ajax({
        ...
        success: function (data) {
            if (data.code == 200) {
                ...
                window.location.href = "/Hino/Service/Index";
