...
var page = 1;
var seach = "";
CateHYUNDAI(pagenum, page, seach);
...
function CateHYUNDAI(pagenum, page, seach) {
    var Stt = 1;
    $.ajax({
        url: '/CateHYUNDAI/List',
        type: 'get',
        ...
        success: function (data) {
            ...
            if (data.code == 200) {
                $.each(data.c, function (k, v) {
                    ...
                    table += '<a class="nav-link" href="/Hino/CateHYUNDAI/Edits/' + v.id + '">';
    ...
    $.ajax({
        ...
        success: function (data) {
            if (data.code == 200) {
                ...
                window.location.href = "/Hino/CateHYUNDAI/Index";
